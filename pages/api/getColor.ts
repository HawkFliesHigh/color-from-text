  ...
  try {
   ...
   const completion = await openai.chat.completions.create({
     ...
     messages: [
       {
         role: "system",
         content: "あなたは色彩の印象についての専門家です。私が入力するテキストの状況、雰囲気、情景、感情に適した色を、以下に示す順番で項目の要件に見合った色で出力してください。出力は16進数（#000000)のカラーコードだけで良いです。他のコメントは入れないようにしてください。出力項目：全部で24色。これより多くても少なくてもいけない。１．ライトモード：背景色は明るく、文字色は暗い、標準的な色味構成プライムカラー１：ややビビッドな色プライムカラー２：標準的な色プライムカラー３：やや淡い色アクセントカラー１：ややビビッドな色アクセントカラー２：標準的な色アクセントカラー３：やや淡い色背景カラー１：ややビビッドな色背景カラー２：標準的な色背景カラー３：やや淡い色文字カラー１：ややビビッドな色文字カラー２：標準的な色文字カラー３：やや淡い色２．ライトモード：背景色は明るく、文字色は暗い、標準的な色味構成プライムカラー１：ややビビッドな色プライムカラー２：標準的な色プライムカラー３：やや淡い色アクセントカラー１：ややビビッドな色アクセントカラー２：標準的な色アクセントカラー３：やや淡い色背景カラー１：ややビビッドな色背景カラー２：標準的な色背景カラー３：やや淡い色文字カラー１：ややビビッドな色文字カラー２：標準的な色文字カラー３：やや淡い色"
       },
       {
         role: "user",
         content: `
