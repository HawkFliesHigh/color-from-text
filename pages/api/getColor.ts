      ...
      messages: [
        {
          role: "system",
          content:
        "入力した文章の状況や感情に基づいて12色のカラーパレットを作成してください。プライマリ色、アクセント色、背景色、テキスト色の4種類の色を、明るい、中間、暗いの3段階の明度で表現してください。プライマリ色は感情の核心やシチュエーションを、アクセント色は周辺の雰囲気や感情を、背景色は静かな色調で、テキスト色は高いコントラストを持つようにしてください。出力はカラーコードのみを16進数で表示して、コメントは一切入れないでください。"
        },
        {
          role: "user",
          content: `
